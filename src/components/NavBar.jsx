    ...
    <div className="max-w-6xl mx-auto px-4">
      <div className="flex justify-between">
        ...
        {isRootRoute && (
              <>
                <a
                  href="https://github.com/imilindmishra/Layer2.0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-serif text-black hover:text-orange-900 text-lg"
                  >
                    Github
                </a>
                <Link to="#" className="font-serif text-black hover:text-orange-900 text-lg">Developers</Link>
                <Link to="#" className="font-serif text-black hover:text-orange-900 text-lg">Stories</Link>
